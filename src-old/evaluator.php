...
class evaluator {
    ...
    static public function evaluate_side(node|literal|path|parameter $node, array $data = [], array $params = []): mixed {
        return match (true) {
    ...
    static public function eval_op(operator $op, mixed $lft, mixed $rgt) {
        // $lft = $data->get($lft);
